...
<template>
    <button
        class="p-2 m-4 z-[200] fixed bottom-0 right-0"
        :class="
            !isVisible
                ? 'shadow-md backdrop-filter backdrop-blur-2xl rounded'
                : ''
        "
        @click="toggleVisible"
    >
    ...
    >
        <section
            class="flex flex-col justify-center items-center gap-10 transition"
        >
            <a
                href="/"
                @click="toggleVisible"
                class="inline-flex items-center gap-2 text-white font-nexaBold text-4xl hover:text-red-500 transition-all py-5 px-20"
                >Domů</a
            >
